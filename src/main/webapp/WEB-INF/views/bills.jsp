...
<body>
  ...
  <div class="container">
    ...
    <div class="content">
      <h2>Bill List</h2>
      <a href="bills/new" class="button">Add New Bill</a>
      <table>
        <tr>
          <th>ID</th>
          <th>Patient</th>
        ...
        <c:forEach var="bill" items="${bills}">
          <tr>
            ...
            <td>${bill.details}</td>
            <td>
              <a href="bills/edit/${bill.id}" class="edit-link">Edit</a> |
              <a href="billss/delete/${bill.id}" class="delete-link" onclick="return confirm('Are you sure you want to delete this bill?');">Delete</a>
